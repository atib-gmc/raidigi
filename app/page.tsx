...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen w-full max-w-3xl flex-col items-center   pt-28 px-8  space-y-8  text-white dark:bg-black sm:items-start">
      <div className="hero w-full p-4 h-[40vh] rounded-2xl bg-white/40 backdrop-blur-3xl  shadow-3xl outline-white/60 outline-[2px]">
        <Image
          src="/hero.png"
          alt="Hero Image"
          layout="fill"
      ...
      <section className="w-full">
        <div className="header items w-full  flex  justify-between mb-2">
          <span className="text-white  text-xs text-start w-full">Popular</span>
          <span className="text-white text-xs text-end w-full">All</span>
        </div>
        <div className="card-wrapper gap-2 h-20 w-full  flex">

          <div className="cards outline-[2px] outline-white/60 grid place-items-center w-20 h-20  rounded-xl bg-white/40   backdrop-blur-2xl">
      ...
      <section className="more w-full">
        ...
        <div className="header items w-full  flex  justify-between mb-2">
          <span className="text-white  text-xs text-start w-full">More</span>
          <span className="text-white text-xs text-end w-full">Show All</span>
        </div>
        <div className="card-wrapper   gap-2 flex w--full">

          <Link href={"/buy"} className="card  max-w-2/4 w-full h-56 p-2 rounded-xl bg-white">
